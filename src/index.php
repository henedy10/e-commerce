          ...
          <div class="flex gap-6">
            <div class="mx-5">
              ...
              <ul class="text-sm leading-8">
                ...
                <li><a href="product-overview.php">Wooden craft bed</a></li>
            ...
            <div class="mx-5">
              ...
              <ul class="text-sm leading-8">
                <li><a href="product-overview.php">Italian Purple Lamp</a></li>
                <li><a href="product-overview.php">APEX Lamp</a></li>
                <li><a href="product-overview.php">PIXAR lamp</a></li>
                <li><a href="product-overview.php">Ambient Nightlamp</a></li>
              </ul>
            </div>
